                ...
                if ($list->existEvent()) {
                    while ($termin = $list->nextEvent()) {
                        ...
                        $events[] = array(
                            ...
                            'end'         => $termin->getEnd(),
                            'iso_start'   => date('c', $termin->getStart()),
                            'iso_end'     => date('c', $termin->getEnd()),
            ...
            $router->get('/events', function () use ($router) {
                ...
                foreach ($calendar->events as $event) {
                        $events[] = array(
                            ...
                            'iso_start'   => date('c', $event->getStart()),
                            'iso_end'     => date('c', $event->getEnd()),
                ...
                foreach ($termine as $singledate_id => $singledate) {
                    if (!$singledate->isExTermin()) {
                        ...
                        $events[] = array(
                                        ...
                                        'iso_start'   => date('c', $singledate->getStartTime()),
                                        'iso_end'     => date('c', $singledate->getEndTime()),
                                        'title'       => $title,
