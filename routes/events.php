                ...
                if ($list->existEvent()) {
                    while ($termin = $list->nextEvent()) {
                        ...
                        $events[] = array(
                            ...
                            'end'         => $termin->getEnd(),
                            'iso_start'   => date('Y-m-d\TH:i:s', $termin->getStart()),
                            'iso_end'     => date('Y-m-d\TH:i:s', $termin->getEnd()),
            ...
            $router->get('/events', function () use ($router) {
                ...
                foreach ($calendar->events as $event) {
                        $events[] = array(
                            ...
                            'iso_start'   => date('Y-m-d\TH:i:s', $event->getStart()),
                            'iso_end'     => date('Y-m-d\TH:i:s', $event->getEnd()),
                ...
                foreach ($termine as $singledate_id => $singledate) {
                    if (!$singledate->isExTermin()) {
                        ...
                        $events[] = array(
                                        ...
                                        'iso_start'   => date('Y-m-d\TH:i:s', $singledate->getStartTime()),
                                        'iso_end'     => date('Y-m-d\TH:i:s', $singledate->getEndTime()),
                                        'title'       => $title,
